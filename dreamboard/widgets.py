...
from dreamboard.config import logfile_name, DreambSettings
...
class WelcomeOverlay(MainControlsMixin, QtWidgets.QWidget):
    ...
    def show(self):
        files = DreambSettings().get_recent_files(existing_only=True)
...
class DreambProgressDialog(QtWidgets.QProgressDialog):
