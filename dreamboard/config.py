...
from dreamboard.dreamb_logger import qt_message_handler
...
class DreambSettings(QtCore.QSettings):
...
class KeyboardSettings(QtCore.QSettings):
    ...
    def __init__(self):
        ...
        filename = os.path.join(
            os.path.dirname(DreambSettings().fileName()),
...
def logfile_name():
    return os.path.join(
        os.path.dirname(DreambSettings().fileName()), f'{constants.APPNAME}.log')
...
logging_conf = {
    ...
    'handlers': {
        ...
        'file': {
            'class': 'dreamboard.dreamb_logger.DreambRotatingFileHandler',
            'formatter': 'verbose',
