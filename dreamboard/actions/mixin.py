...
class ActionsMixin:
    ...
    def build_menu_and_actions(self):
        ...
        self.toplevel_menus = []
        self.dreamb_actions = {}
        self.dreamb_actiongroups = defaultdict(list)
        self._post_create_functions = []
        self._create_actions()
        self._create_menu(self.dreamb_actions, self.context_menu, menu_structure)
    ...
    def _create_actions(self):
        for action in actions:
            ...
            self.dreamb_actions[action['id']] = qaction
            if 'group' in action:
                self.dreamb_actiongroups[action['group']].append(qaction)
    ...
    def _build_recent_files(self, menu=None):
        ...
        for i, filename in enumerate(files):
            ...
            self.dreamb_actions[action_id] = qaction
    ...
    def _clear_recent_files(self):
        ...
        for key in list(self.dreamb_actions.keys()):
            if key.startswith('recent_files_'):
                self.dreamb_actions.pop(key)
